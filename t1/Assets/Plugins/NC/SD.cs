...
public class SD : MonoBehaviour {
	...
	int uvAnimationTileX = 8; //Here you can place the number of columns of your sheet. 
                           //The above sheet has 24

	int uvAnimationTileY = 4; //Here you can place the number of rows of your sheet. 
